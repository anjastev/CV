...
const App = () => {
    return (
        <div className="container">
            ...
            <section>
                <h2 className="section-title">🔍 Професионално Резиме</h2>
                <p>Талентиран UX/UI дизајнер и веб развивач со искуство во креирање интуитивни и визуелно привлечни веб апликации. Постојано се стремам да создадам иновативни решенија и да го подобрам корисничкото искуство со користење на најновите технологии и дизајн трендови.</p>
            </section>
            ...
            <section>
                <h2 className="section-title">🎯 Работно Место за Кое Аплицирате</h2>

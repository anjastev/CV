...
<section id="projects" className="projects-section">
  ...
  <div className="projects-grid">
    <div className="project-item">
      ...
      <p>Веб апликација за планирање на патувања, развиена како дел од проект во прва година на факултетот. Апликацијата им овозможува на корисниците да креираат персонализирани планови за патување, да ги следат своите дестинации 🗺️, да поставуваат времиња и маршрути ⏳, и да прегледуваат препораки за хотели 🏨 и активности во избраните локации. TravelPlannerApp е изградена со HTML, CSS и JavaScript, и користи локално складирање за податоците на корисниците. <br></br>
      <a href="https://webdesignproject.vercel.app/" target="_blank" rel="noopener noreferrer">Погледнете ја апликацијата тука</a>.
      </p>
    </div>
    <div className="project-item">
      <h3>📅 Обврски365</h3>
      <p>Обврски365 е веб апликација развиена во React, со цел управување со задачи и активности 📅. Корисниците можат да креираат, изменуваат и бришат задачи 🗒️, да поставуваат рокови и приоритети ⏰, и да следат прогрес преку интуитивен интерфејс. Апликацијата исто така вклучува можност за категоризација на задачи и дневни известувања 🔔, со што корисниците можат лесно да останат организирани и продуктивни. <br></br>
      <a href="https://my-planner-app-eight.vercel.app/" target="_blank" rel="noopener noreferrer">Погледнете ја апликацијата тука</a>.
      </p>
    </div>
    <div className="project-item">
      <h3>🏨 Hotel Reservation App - CheckInn</h3>
      <p>CheckInn е веб апликација за резервација на хотели, изградена користејќи React за frontend и Java за backend. Апликацијата им овозможува на корисниците да пребаруваат хотели според различни критериуми како локација 📍, цена 💸 и оценка ⭐, да прегледуваат детали за хотелите и да направат резервации. CheckInn исто така поддржува кориснички профили 👤, каде што корисниците можат да го следат статусот на своите резервации и да ги управуваат истите. Целта на оваа апликација е да обезбеди брзо и лесно решение за резервација на хотели со чист и интуитивен интерфејс. <br></br>
      <a href="https://hotel-reservations-pink.vercel.app/" target="_blank" rel="noopener noreferrer">Погледнете ја апликацијата тука</a>.
      </p>
    </div>
  </div>
</section>
